...
def display_results(results, annotat_df, top_n=5):
    ...
    for result in results:
        ...
        if is_valid_image_url(image_path):
            st.image(image_path, caption=f"{captions}", use_column_width=True)
            count += 1
...
st.title("Semantic Image Search Engine Using CLIP")
...
with tab2:
    ...
    sample_image_paths = ["sample_images/airplane.jpg", "sample_images/bikes.jpg", "sample_images/hotdog.jpg", "sample_images/phone.jpg","sample_images/eating.jpg"]
